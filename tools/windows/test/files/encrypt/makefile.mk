...
ROOT = ..\..\..\..\..
TEST_ROOT = ${ROOT}\test\files
ENCRYPT_ROOT = ${TEST_ROOT}\encrypt


SRC = ${ROOT}\src
SRC_TEST = ${TEST_ROOT}\src
SRC_ENCRYPT = ${ENCRYPT_ROOT}\src
...
OBJ = ${ROOT}\obj\windows\test\files\encrypt

BUILD = ${ROOT}\build\windows\test\files\encrypt


APP = ${BUILD}\app.exe


MAIN_C = ${SRC_ENCRYPT}\main.c
MAIN_O = ${OBJ}\main.o
